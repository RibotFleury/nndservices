...
const languageData = {
  en: {
    ...
    navContact: "Contact",
    navDonate: "Donate",
    titreLivraison: "Get a quick quote for delivery service",
    labelName: "Name",
    labelTel: "Tel.",
    labelEmail: "E-mail",
    labelDate: "Delivery date",
    labelTime: "Delivery time",
    labelPickupAddress:
      "Pick-up Address (address, city, province, Postal code)",
    labelAccessPU: "Accessibility of Pick-up Address",
    labelDropoffAddress:
      "Delivery Address (address, city, province, Postal code)",
    labelAccessDO: "Accessibility of Drop-off Address",
    labelSubject:
      "Item Description (Size, weight, and type of items to be delivered)",
    labelMessage:
      "Special Instructions (Any specific requirements or handling instructions)",
  ...
  fr: {
    ...
    titreLivraison: "Obtenez un devis rapide pour le service de livraison",
    labelName: "Nom",
    labelTel: "Tél.",
    labelEmail: "E-mail",
    labelDate: "Date de Livraison",
    labelTime: "Heure de Livraison",
    labelPickupAddress:
      "Adresse de Ramassage (adresse, ville, province, code postal)",
    labelAccessPU: "Accessibilité de l'Adresse de Ramassage",
    labelDropoffAddress:
      "Adresse de Livraison (adresse, ville, province, code postal)",
    labelAccessDO: "Accessibilité de l'Adresse de Dépôt",
    labelSubject:
      "Description de l'Article (Taille, poids et type d'articles à livrer)",
    labelMessage:
      "Instructions Spéciales (Exigences ou instructions spécifiques)",
    ...
    footerDesignedBy: "Développé par ",
    footerRibo: "EvolveD",
...
function changeLanguage() {
  ...
  //form title
  document.getElementById("titre-livraison").textContent = lang.titreLivraison;
